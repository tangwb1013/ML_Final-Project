...
def random_gamma(image):
    ...
    training images.
    Refer to: http://www.pyimagesearch.com/2015/10/05/opencv-gamma-correction/
    """
...
def random_shear(image, steering_angle, shear_range=200):
    """
    Apply random shear on the source image
    Refer to: https://medium.com/@ksakmann/behavioral-cloning-make-a-car-drive-like-yourself-dc6021152713#.7k8vfppvk
...
def generate_new_image(image, steering_angle, top_crop_percent=0.35, bottom_crop_percent=0.1,
    ...
    """
    Apply all the preprocessing operations
    """
